...
import { Wrench, Zap, Wind, ShieldCheck, Briefcase, Trash2, Plus } from 'lucide-react';
    ...
    <div className="space-y-8 pb-20 animate-in fade-in duration-500">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {slots.map(index => {
          ...
          return (
            <div key={index} className={`relative min-h-[220px] rounded-3xl border-2 p-6 flex flex-col justify-center transition-all ${
