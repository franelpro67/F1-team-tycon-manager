...
import { LayoutDashboard, Users, Wrench, Trophy, Info, Briefcase, Coins, RotateCcw } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab, hasNewOffers, onReset, teamColor = 'red' }) => {
  const menuItems = [
